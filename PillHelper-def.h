 ...
 * Pill Helper - Caixa de Remédios Inteligente     *
 * Versão 1.0 - 08/2020                            *
 * Desenvolvido por Equipe G2                      *
 * - Beatriz Almeida Nunes de Oliveira             *
 * - Cauê de Abreu Balista                         *
 * - Cauê Souza de Barros                          *
 * - Erik Bezerra Pereira da Silva                 *
 * - José Victor Damianci Pires                    *
 * - Leonardo Pigatto Bueno                        *
 ***************************************************/
...
********************************************************************************/
// URL da API
const char* API_URL = "https://us-central1-pillhelperoficiall.cloudfunctions.net/api/Caixa/getAlarmes";
